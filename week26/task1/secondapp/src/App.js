...
function App() {
  return (
    <div>
      {
        heroes.map((hero) =>
          <Superhero name={hero.name} src={hero.src} universe={hero.universe} alter_ego={hero.alter_ego} career={hero.career} friends={hero.friends} superpowers={hero.superpowers} learn_more={hero.learn_more}></Superhero>
        )
      }
    </div>
  );
